require([
    ...
    $(document).ready(function() {
        ...
        // jQuery('.tab-list .selected').html(tabTitle);
            ...
            (function(){
                ...
                jQuery('.tab-list').delegate('.tab', 'click', function() {
                    ...
                    if( jQuery(window).width() < breakTab ){
                        ...
                        jQuery('.tab-list .selected').html(jQuery('.tab-list .tab.active').html());
                ...
                function dropDownTab(){
                    ...
                    if( !cloneSelected ){
                        ...
                        jQuery('.tab-list').prepend("<div class='selected'>"+jQuery(".tab.active").html()+"</div>");
                ...
                jQuery(window).scroll(function(){
                    ...
                    jQuery('[id^=tab-]').each(function(){
                        ...
                        if (
                            ...
                            jQuery(window).scrollTop() + jQuery('header').outerHeight() + jQuery('.tab-list').outerHeight() +100 >= jQuery(this).offset().top - 1

                            && jQuery(this).offset().top + jQuery(this).outerHeight() + parseFloat(jQuery(this).css('margin-bottom')) > jQuery(window).scrollTop() + jQuery('header').outerHeight() + jQuery('.tab-list').outerHeight() +100
                            ...
                            if( jQuery('.tab-list .selected').length ){
                                ...
                                jQuery('.tab-list .selected').html(jQuery(".tab.active").html());
        ...
        // var tabTitle = $('.page-main .tab-list .options .active').html();

        // $('.page-main .tab-list .selected').empty();

        // $('.page-main .tab-list .selected').append(tabTitle);
